...
# Creating the par for multiple plottings
par(mfrow=c(2,2))
...
names = names(data)
legend("topright", legend = names[6:8], col=c("black","red","blue"),lty=c(1,1,1), bty="n")


# Plotting the fourth plot
with(data, plot(Date, Global_reactive_power, type="l", xlab="datetime", ylab=names[3]))
